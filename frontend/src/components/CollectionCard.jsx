...
const CollectionCard = ({ collection }) => {
  ...
  // Use previewImage directly if it exists, otherwise fallback
const imageUrl =
  collection.previewImage ||
  "https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=500";

    console.log("Collection image URL:", imageUrl);
  ...
  return (
    ...
    >
      ...
      {/* Info always visible */}
      <div className="p-5">
        <h3 className="font-semibold text-lg sm:text-xl truncate mb-1">{collection.name}</h3>
